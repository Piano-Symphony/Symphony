      ...
      <div v-for="sheet in sheets"  v-bind:key="sheet.id" class="col-md-6 col-xl-4 col-12 pt-3 d-flex">
       ...
       <div class="card-body">
        <h5 class="card-title">{{sheet.name}}</h5>
          ...
          <router-link to="/videomaster"><button class="btn btn-success" style='margin-right:30px' v-on:click="download(sheet.videoURL)">Watch</button></router-link>
...
import { sheetApi } from "../api/masterSheet";
